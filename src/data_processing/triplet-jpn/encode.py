from datasets import load_dataset, get_dataset_config_names, get_dataset_config_info, concatenate_datasets
import argparse
...
def main(args):
    ...
    subset_to_target_num_examples = {
        subset: int(num_examples * down_sampling_ratio) for subset, num_examples in subset_to_num_examples.items()
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="data/triplet-jpn", help="Path to save the output directory")
    parser.add_argument(
