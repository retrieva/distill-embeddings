...
#PJM -j
#PJM -o logs/final/resume_17.log
...
# Experiment params (match final_result/17.sh)
...
echo "Resuming 17 (infocse, no pos) from: ${CKPT} (run_id=${RUN_ID:-none})"
