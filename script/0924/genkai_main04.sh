...
#PJM -j
#PJM -o logs/0916/genkai_main04.log
...
run_job "7" logs/final/63.log bash script/final_result/28.sh
run_job "6" logs/final/64.log bash script/final_result/29.sh
run_job "5" logs/final/65.log bash script/final_result/30.sh
run_job "4" logs/0924/resume_32.log bash script/0924/resume_32.sh
